...
parser.add_argument("--remove-jupyter-messages",
                    action="store_true",
                    help="Remove Jupyter messages from the data")

parser.add_argument("--remove-python-messages",
                    action="store_true",
                    help="Remove Python messages from the data")
