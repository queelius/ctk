...
def ollama_config() -> Dict[str, Any]:
    ...
    return {"model": "llama3.1", "base_url": "http://localhost:11434", "timeout": 120}
...
class TestOllamaProviderInitialization:
    ...
    def test_initialization_with_custom_base_url(self):
        ...
        provider = OllamaProvider(
            {"model": "mistral", "base_url": "http://custom-host:8080"}
        )
    ...
    def test_initialization_with_custom_timeout(self):
        ...
        provider = OllamaProvider({"model": "llama3.1", "timeout": 60})
