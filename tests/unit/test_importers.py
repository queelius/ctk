...
class TestOpenAIImporter:
    ...
    def test_import_single_conversation(self, openai_export_data):
        ...
        assert conv.metadata.model in [
            "gpt-4",
            "GPT-4",
            "ChatGPT",
        ]  # Can be mapped, raw, or default
        ...
        data = [
            {
                ...
                "name": "Chat 1",
                "chat_messages": [
                    {"uuid": "msg_1", "text": "Question", "sender": "human"}
                ],
            },
            {
                "uuid": "conv_2",
                "name": "Chat 2",
                "chat_messages": [
                    {"uuid": "msg_2", "text": "Another question", "sender": "human"}
                ],
            },
        ]
...
class TestOpenAIImporterValidation:
    ...
    def test_validate_correct_format(self):
        ...
        importer = OpenAIImporter()
        data = {"mapping": {}, "conversation_id": "test"}
...
class TestGeminiImporter:
    ...
    def test_validate_correct_format(self):
        ...
        data = {"conversation_id": "test", "turns": []}
        assert importer.validate(data)
