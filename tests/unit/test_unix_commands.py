...
class TestUnixCommands:
    ...
    @pytest.mark.unit
    def test_cat_message_file_text(
        self, unix_commands, mock_db, mock_tui, sample_conversation
    ):
    ...
    @pytest.mark.unit
    def test_cat_message_file_role(
        self, unix_commands, mock_db, mock_tui, sample_conversation
    ):
    ...
    @pytest.mark.unit
    def test_cat_message_file_timestamp(
        self, unix_commands, mock_db, mock_tui, sample_conversation
    ):
    ...
    @pytest.mark.unit
    def test_cat_message_file_empty_text(
        self, unix_commands, mock_db, mock_tui, sample_conversation
    ):
    ...
    @pytest.mark.unit
    def test_cat_invalid_message_node(
        self, unix_commands, mock_db, mock_tui, sample_conversation
    ):
    ...
    @pytest.mark.unit
    def test_cat_message_out_of_range(
        self, unix_commands, mock_db, mock_tui, sample_conversation
    ):
    ...
    @pytest.mark.unit
    def test_cat_unknown_metadata_file(
        self, unix_commands, mock_db, mock_tui, sample_conversation
    ):
    ...
    def test_head_path_error_propagates(self, unix_commands):
        ...
        with patch.object(unix_commands, "cmd_cat") as mock_cat:
            mock_cat.return_value = CommandResult(
                success=False, output="", error="File not found"
            )
