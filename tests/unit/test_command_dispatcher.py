...
from ctk.core.shell_parser import ParsedCommand, ParsedPipeline, ShellParser
...
class TestCommandDispatcher:
    ...
    def test_register_multiple_commands(self):
        ...
        dispatcher = CommandDispatcher()
        commands = {"cmd1": cmd_echo, "cmd2": cmd_cat, "cmd3": cmd_grep}
...
class TestCommandResult:
    ...
    def test_command_result_creation(self):
        ...
        result = CommandResult(
            success=True, output="test output", error=None, exit_code=0
        )
    ...
    def test_command_result_with_error(self):
        ...
        result = CommandResult(
            success=False, output="", error="Something failed", exit_code=1
        )
