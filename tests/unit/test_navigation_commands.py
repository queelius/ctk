...
from ctk.core.commands.navigation import NavigationCommands, create_navigation_commands
...
class TestNavigationCommands:
    ...
    @pytest.mark.unit
    def test_cd_relative_from_trailing_slash(self, nav_commands, mock_navigator, mock_tui):
    ...
    @pytest.mark.unit
    def test_cd_short_prefix_no_resolution(self, nav_commands, mock_navigator, mock_tui):
    ...
    def test_cd_nonexistent_directory(self, nav_commands, mock_navigator, mock_tui):
        ...
        with patch.object(VFSPathParser, 'parse', return_value=mock_parsed):
            mock_navigator.list_directory.side_effect = ValueError("Directory not found")
            mock_navigator.resolve_prefix.return_value = None
    ...
    @pytest.mark.unit
    def test_ls_relative_path_with_trailing_slash(self, nav_commands, mock_navigator, mock_tui):
