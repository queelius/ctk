...
class TestMessageContent:
    ...
    def test_multimodal_content(self):
        ...
        content = MessageContent(
            text="Look at this", images=["image1.png", "image2.jpg"]
        )
    ...
    def test_tool_content(self):
        ...
        content = MessageContent(text="Let me help", tool_calls=tool_calls)
...
class TestConversationMetadata:
    ...
    def test_metadata_dict_conversion(self):
        ...
        meta = ConversationMetadata(
            source="anthropic", model="claude-3", tags=["ai", "chat"]
        )
...
class TestConversationTree:
    ...
    def test_get_children(self):
        ...
        msg1 = Message(
            id="msg_001", role=MessageRole.USER, content=MessageContent(text="Parent")
        )
        conv.add_message(msg1)
    ...
    def test_get_all_paths(self):
        ...
        msg1 = Message(
            id="msg_001", role=MessageRole.USER, content=MessageContent(text="Start")
        )
        conv.add_message(msg1)
        ...
        assert ["msg_001", "msg_002a"] in path_ids or [
            "msg_001",
            "msg_002b",
        ] in path_ids
    ...
    def test_conversation_with_metadata(self):
        ...
        meta = ConversationMetadata(
            source="openai", model="gpt-4", tags=["test", "ai"], project="research"
        )
        conv = ConversationTree(id="conv_001", title="Test Chat", metadata=meta)
