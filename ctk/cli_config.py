...
from ctk.core.config import get_config, Config
...
def add_config_commands(subparsers):
    ...
    get_parser.add_argument('key', help='Configuration key (dot notation, e.g., providers.ollama.base_url)')
    ...
    # edit
    edit_parser = config_subparsers.add_parser('edit', help='Open config file in editor')
...
def dispatch_config_command(args):
    ...
    if hasattr(args, 'config_command') and args.config_command:
        ...
        print("Error: No config command specified. Use 'ctk config --help' for available commands.")
        return 1
